...
class AllWheat extends StatefulWidget {
  @override
  _AllWheatState createState() => _AllWheatState();
}

class _AllWheatState extends State<AllWheat> {
  @override
  Widget build(BuildContext context) {
    return SafeArea(
      ...
      body: StreamBuilder<List<WheatModel>>(
