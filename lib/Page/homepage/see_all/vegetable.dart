...
class AllVegetable extends StatefulWidget {
  @override
  _AllVegetableState createState() => _AllVegetableState();
}

class _AllVegetableState extends State<AllVegetable> {
  @override
  Widget build(BuildContext context) {
    return SafeArea(
      ...
      body: StreamBuilder<List<VegetablesModel>>(
